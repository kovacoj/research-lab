...
The markdown parser understands sections like `Topic`, `Context`, `Domains`, `Must Include`, `Must Exclude`, and the numeric knobs such as `Iterations` or `Top K`. Sections must be written as Markdown headings (e.g. `# Topic`, `## Context`) or as label lines (e.g. `Topic:`, `Context:`).
...
<!-- issues:start -->
- [#62](https://github.com/kovacoj/research-lab/issues/62) tests fail
- [#51](https://github.com/kovacoj/research-lab/issues/51) auto PR reviewer
<!-- issues:end -->
